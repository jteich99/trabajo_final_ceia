...
En este capítulo se presentan las principales conclusiones obtenidas del trabajo realizados y se plantean posibles líneas de trabajo futuro para continuar y ampliar el desarrollo. 
...
En esta sección, se exponen las conclusiones generales de los modelos desarrollados en el trabajo. Se analiza el desarrollo y los resultados alcanzados para la estimación de Potencia Límite de Canal (PLC) y la predicción del Flujo Crítio de Calor (CHF).
