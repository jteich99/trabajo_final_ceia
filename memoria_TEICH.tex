...
\newcommand{\lfdnn}{\texttt{LFDNN}}
\newcommand{\mfdnn}{\texttt{MFDNN}}
\newcommand{\hfdnn}{\texttt{HFDNN}}
\newcommand{\mfpinn}{\texttt{MFPINN}}
\newcommand{\lfpinn}{\texttt{LFPINN}}
\newcommand{\dnbrmin}{$\mathrm{DNBR}_\mathrm{min}$}
...
\vspace{1.5cm}
Quiero agradecer en primer lugar a Nucleoeléctrica Argentina por el apoyo económico para la realización de esta Especialización. En segundo lugar a Martín, mi jefe y director, por la guía y largas charlas para lograr llevar este trabajo a buen puerto. 

Agradecer a mis padres por su inagotable apoyo. Y por último, a Victoria (y Morita) por la paciencia y companía durante largas horas de estudio y trabajo. Todo esto carecería de sentido sin ellos.
...
\dedicatory{\textbf{Dedicado a Osvaldo, Susana y Alicia.}}
...
\include{Chapters/Appendix_groeneveld}
\include{Chapters/Appendix_resultados}
