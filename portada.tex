...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        \textbf{Director:} Mg. Ing. Martín Sebastián Silva (Nucleoeléctrica Argentina S.A.)} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Ing. Gastón H. Pintos (Nucleoeléctrica Argentina S.A. / FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Dr. Ing. Benjamín A. Tourn (UNRaf / FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Lic. Fabricio Lopretto (FIUBA)} \\[1cm]


        % Fecha y lugar
        {\fontfamily{phv}\itshape\fontsize{10pt}{12pt}\selectfont
        Ciudad de Buenos Aires, octubre de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
